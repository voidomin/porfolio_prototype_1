...
- [x] Homepage redesign — phase 4: hero interactive vector illustration (`TrailHiker.tsx`, a cursor-reactive hiker on a ridge) + a real "Built for this trail with" tech-logo strip (`TechStackStrip.tsx`, react-icons/si brand marks) surfaced right after the hero instead of staying buried in the Meadow chapter.
