      ...
      >
        {filteredPhotos.map((photo, index) => (
          <motion.button
            ...
            className="cursor-pointer group relative overflow-hidden bg-stone-950 shadow-md hover:shadow-xl hover:shadow-stone-950/20 border border-transparent hover:border-dawn-500/40 transition-all duration-500 text-left w-full block"
            onClick={() => openLightbox(photo)}
          >
            <img
              src={photo.src}
